...
ADMIN: 어드민 버튼
POST: 게시판에서 게시글 작성 시 사용되는 게시하기 버튼입니다.
SEARCH: 검색 버튼
INFO: 정보 버튼
none: 버튼이 없는 경우입니다.
